...
inline val MediaMetadataCompat.albumArtUri: Uri
    get() {
        val uri = this.getString(MediaMetadataCompat.METADATA_KEY_ALBUM_ART_URI)
        return uri?.toUri() ?: Uri.EMPTY
    }
...
inline val MediaMetadataCompat.displayIconUri: Uri
    get() {
        val uri = this.getString(MediaMetadataCompat.METADATA_KEY_DISPLAY_ICON_URI)
        return uri?.toUri() ?: Uri.EMPTY
    }
